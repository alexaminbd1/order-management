...
import { updateUserSchema, updateUserType } from "@/lib/schema/users-schema"
...
const postData = async ({ data, id }: { data: updateUserType; id: string }) => {
  const response = await axios.patch(`/api/v1/user/edit/${id}`, data)
...
export default function EditUser({
  ...
  const form = useForm<updateUserType>({
    ...
    defaultValues: {
      ...
      paymentNumber: paymentNumber ? paymentNumber : undefined,
      paymentType: paymentType ? paymentType : "",
      phone,
      payOutAmount: payOutAmount ? payOutAmount : undefined,
      status,
      roles,
    },
  })
      ...
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <div className="grid grid-cols-3 gap-4 items-start">
          <div className="grid gap-4 col-span-2">
            <Card className="">
              <CardHeader>
                <CardTitle>Update User Details And Login Information</CardTitle>
                <CardDescription>
              ...
              <CardContent className="grid gap-5">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Please Type Update Password</FormLabel>
                      <FormControl>
                        <Input
                          placeholder="********"
                          type="password"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        You Can update Current Balance
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
